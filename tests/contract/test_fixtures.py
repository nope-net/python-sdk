...
FIXTURE_MODELS: Dict[str, str] = {
    ...
    "evaluate/try.gb.no-resources.json": "EvaluateResponse",
    "evaluate/try.gb.text.json": "EvaluateResponse",
    ...
    "ocular/auth.per-turn.json": "OcularResponse",
    ...
    "signpost/by-id.json": "SignpostByIdResponse",
